    ...
    <footer className="relative mt-24">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <div>
               ...
               <span className="font-bold text-gray-500 flex items-center gap-2">  <SiSwisscows /> Qurbani  <FaHatCowboySide /></span> 
               {/* <span className="font-bold text-amber-300 flex items-center">Hat <PiCowBold /></span> */}
              </h2>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <Button   className="inline-flex items-center justify-center px-5 py-2.5 rounded-full 
              ...
              hover:scale-[1.02] hover:shadow-lg hover:shadow-black/10 dark:hover:shadow-white/10">Get Started</Button>
          </div>
        </div>
        ...
        <div className="mt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
          <p>© {new Date().getFullYear()} Qurbani. All rights reserved.</p>
