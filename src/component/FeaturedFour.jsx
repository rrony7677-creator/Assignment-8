...
const FeaturedFour =async () => {
    ...
    return (
        <div>
        <h2 className="text-3xl text-center font-bold text-gray-500 mt-[90px] mb-[10px]">Animals Features </h2>
        <p className="mb-[20px] text-center text-gray-500 max-w-7xl mx-auto">Animal features on this site highlight a variety of livestock breeds, such as the Deshi Shahi Cow <br /> and Black Bengal Goat, specifically curated for the Qurbani festival.</p>
